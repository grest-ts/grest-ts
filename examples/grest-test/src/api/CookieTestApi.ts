...
// A plain context key, bound to a cookie via GGCookie.middleware(SESSION). Read via .get(); write via
// GGCookie.setCookie(SESSION, value, options?). The key's name ("session") is the cookie's wire name.
